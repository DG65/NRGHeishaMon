...
1. **Modulverwaltung → Symcon Store** → „HeishaMon" suchen und hinzufügen, dabei den **Beta-Kanal** wählen (führt den aktuellen Funktionsstand; der Stable-Kanal folgt zu gegebener Zeit).
